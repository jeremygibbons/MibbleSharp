// <auto-generated />
// <copyright file="Asn1Parser.cs" company="Gibb Co">
...
namespace MibbleSharp.Asn1
{
    ...
    /// <summary>A token stream parser.</summary>
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="Asn1Parser"/> class.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Asn1Parser"/> class.
        /// </summary>
        /// <param name="tokenizer">The tokenizer to be used</param>
        /// <param name="analyzer">The analyzer to be used</param>
        ...
        private void CreatePatterns()
        {
            ...
            pattern = new ProductionPattern(
                (int)Asn1Constants.MODULE_DEFINITION,
                "ModuleDefinition");
            alt = new ProductionPatternAlternative();
            ...
            pattern = new ProductionPattern(
                (int)Asn1Constants.MODULE_IDENTIFIER,
                "ModuleIdentifier");
            alt = new ProductionPatternAlternative();
