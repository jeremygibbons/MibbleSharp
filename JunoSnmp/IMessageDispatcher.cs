...
namespace JunoSnmp
{
    ...
    public interface IMessageDispatcher : ITransportListener
    {
        ...
        /// <summary>
        /// Adds a <see cref="ICommandResponder"/> instance to the message dispatcher.
        ...
        /// uses the <see cref="CommandResponderEvent.setProcessed(bool processed)"/>
        /// to set the processed status of the event to<code>true</code>.
        /// </summary>
        /// <param name="listener">A <see cref="ICommandResponder"/> instance</param>
        void AddCommandResponder(ICommandResponder listener);
        
        /// <summary>
        /// Removes a previously added <see cref="ICommandResponder"/> instance from
        /// the message dispatcher.
        /// </summary>
        /// <param name="listener">A <see cref="ICommandResponder"/> instance</param>
        void RemoveCommandResponder(ICommandResponder listener);
